# GenesisCode Feature Matrix (Audit Date: 2026-08-14)
...
| `CAP-DENY-DEFAULT-POLICY` | Deny-by-default capability policy runtime | foundation | **L1** | L1 | L1 | L0 | L0 | H2 | `effect-runtime` |
| `CAP-EFFECT-REPLAY` | Deterministic effect logs + replay checker | foundation | **L1** | L1 | L1 | L0 | L0 | H2 | `effect-runtime` |
...
- `R4.2.e`: Make package, registry, and VCS logic GenesisCode-authoritative. Affected claims: `CAP-SEMANTIC-VCS`, `CAP-PACKAGE-MANAGER`, `CAP-ARTIFACT-GC`, `CAP-STRICT-NO-FALLBACK`
