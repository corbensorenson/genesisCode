...
- [ ] Decompose Rust megafiles into domain modules with stable internal interfaces.
  ...
  - Remaining for closure: split `gc_effects::runner_capability_dispatch` capability arms by domain (`sync/pkg/vcs/gc`) into focused command modules; continue Stage2 extractions by moving callable-resolution/emitter helper clusters out of `gc_opt::stage2_wasm`.
