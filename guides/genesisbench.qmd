...
The v0.1 protocol, schemas, verifier, four non-combinable tracks, frozen reference agent, eight controlled ablations over nine shared lineages, nine-lineage/27-context public practice suite, predeclared statistical analysis, construct-validity and anti-gaming study, scorer, canonical eleven-command CLI, five closed adapter classes, strict replay, deterministic run bundles, signed append-only registry, lexicographic static leaderboard, 90-lineage active temporal epoch, maintained post-release capability-lease overlay, and deterministic eligibility and analysis fixtures exist now. Reproducible multi-model baselines, benchmark card, and methods paper are R1.4.o.
