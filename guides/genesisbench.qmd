...
The compiler is not a model adapter. Provider/local adapters, canonical run execution, and full run-bundle emission belong to R1.4.l and must preserve this plan and trace contract exactly.
