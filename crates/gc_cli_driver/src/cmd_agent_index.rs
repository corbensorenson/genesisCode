...
pub(super) fn cmd_agent_index(
    ...
    let mut docs = serde_json::json!({
        ...
        "genesisbench_reference_agent": "docs/spec/GENESISBENCH_REFERENCE_AGENT_v0.1.json",
        "genesisbench_reference_agent_ablations": "docs/spec/GENESISBENCH_REFERENCE_AGENT_ABLATIONS_v0.1.json",
        "genesisbench_reference_agent_trace_schema": "docs/spec/GENESISBENCH_REFERENCE_AGENT_TRACE_v0.1.schema.json",
        "genesisbench_front_door": "docs/spec/GENESISBENCH_FRONT_DOOR_v0.1.md",
        ...
        "genesisbench_bundle_manifest_schema": "docs/spec/GENESISBENCH_BUNDLE_MANIFEST_v0.1.schema.json",
        "genesisbench_analysis_plan": "docs/spec/GENESISBENCH_ANALYSIS_PLAN_v0.1.json",
