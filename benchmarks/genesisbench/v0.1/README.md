...
The four tracks and content-addressed cohort contract are R1.4.h. The fixed Cold Acquisition scaffold is R1.4.k, the signed append-only registry is R1.4.m, and temporal challenge payloads are R1.4.j. None is implied by this conformance fixture beyond the track/cohort contract itself.
