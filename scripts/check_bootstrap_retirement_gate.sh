...
DISK_AUTO_RECLAIM="${GENESIS_BOOTSTRAP_RETIREMENT_DISK_AUTO_RECLAIM:-1}"
REPORT_PATH="${GENESIS_BOOTSTRAP_RETIREMENT_REPORT:-.genesis/perf/bootstrap_retirement_gate_report.json}"
