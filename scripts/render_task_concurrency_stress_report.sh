...
try:
    ...
    raise SystemExit("task-concurrency-stress: GENESIS_TASK_STRESS_MAX_FAILURE_RATE_PCT must be numeric")
if not 0.0 <= value <= 100.0:
    raise SystemExit("task-concurrency-stress: GENESIS_TASK_STRESS_MAX_FAILURE_RATE_PCT must be within [0, 100]")
PY
