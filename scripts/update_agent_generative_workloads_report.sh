...
PERSISTENT_REPORT_PATH="${GENESIS_AGENT_GENERATIVE_REPORT:-.genesis/perf/agent_generative_workloads_report.json}"
PERSISTENT_HISTORY_PATH="${GENESIS_AGENT_GENERATIVE_HISTORY:-.genesis/perf/agent_generative_workloads_history.jsonl}"

exec bash scripts/render_agent_generative_workloads_report.sh \
