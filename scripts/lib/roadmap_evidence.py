...
BUNDLES: Mapping[str, Sequence[str]] = {
    ...
    "generated-authority-closure-bundle": (
        "policies/check_update_boundary_v0.1.json",
        "docs/spec/GENERATED_AUTHORITY_GRAPH_v0.1.schema.json",
        "docs/spec/CHECK_UPDATE_BOUNDARY_v0.1.md",
        "docs/spec/CHECK_UPDATE_BOUNDARY_AUDIT_v0.1.json",
        "scripts/lib/generated_authority.py",
        "scripts/update_generated_authority.sh",
        "scripts/check_generated_artifact_policy.sh",
        "scripts/lib/check_update_boundary.py",
    ...
    "authoring-skill-bundle": (
        ...
        "scripts/lib/genesiscode_authoring_skill.py",
        "scripts/update_agent_authoring_bundle.sh",
        "scripts/check_genesiscode_authoring_skill.sh",
        "scripts/check_write_genesiscode_skill_pack.sh",
        "scripts/check_write_genesiscode_skill_guide.sh",
    ...
    "oom-containment-bundle": (
        ...
        "crates/gc_kernel/src/compiled_blob.rs",
        "crates/gc_kernel/src/eval.rs",
        "crates/gc_kernel/src/eval_prims/text_bytes.rs",
        "crates/gc_kernel/src/eval_value_ops.rs",
        "crates/gc_kernel/src/fallible_alloc.rs",
        "crates/gc_kernel/src/lib.rs",
        "crates/gc_kernel/src/tests.rs",
    ...
    "ci-release-full-closure-bundle": (
        ".github/actions/release-evidence-environment/action.yml",
        ".github/workflows/ci.yml",
        ...
        "docs/spec/RELEASE_EVIDENCE_WORKER_v0.2.schema.json",
        "docs/spec/TEST_EXECUTION_PROFILES_v0.1.md",
        "policies/ci_control_plane_v0.1.json",
        "policies/release_evidence_dag_v0.2.json",
        "scripts/check_test_execution_profile_matrix.sh",
        "scripts/lib/ci_liveness_watchdog.py",
        "scripts/lib/ci_runner_preflight.py",
        "scripts/lib/health_profile_evidence.py",
        "scripts/lib/release_evidence_dag.py",
        "scripts/lib/release_evidence_execution.py",
    ...
    "hard-cancellation-bundle": (
        ...
        "scripts/lib/host_handle_lifecycle_evidence.py",
