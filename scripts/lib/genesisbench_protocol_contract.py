...
AUTHORITY_PATHS = {
    ...
    "genesisbench-construct-policy": "policies/genesisbench_construct_validity_v0.1.json",
    "genesisbench-construct-report": "benchmarks/genesisbench/v0.1/construct-validity/report.json",
    "genesisbench-construct-report-schema": "docs/spec/GENESISBENCH_CONSTRUCT_VALIDITY_v0.1.schema.json",
    "genesisbench-construct-runtime": "scripts/lib/genesisbench_construct_validity.py",
    "genesisbench-construct-integration-test": "crates/gc_cli/tests/cli_genesisbench_construct_validity.rs",
    ...
    "genesisbench-registry-authority": "docs/spec/GENESISBENCH_REGISTRY_v0.1.json",
    "genesisbench-registry-runtime": "scripts/lib/genesisbench_registry.py",
    "genesisbench-registry-integration-test": "crates/gc_cli/tests/cli_genesisbench_registry.rs",
    "genesisbench-submission-claim-schema": "docs/spec/GENESISBENCH_SUBMISSION_CLAIM_v0.1.schema.json",
    "genesisbench-signed-submission-schema": "docs/spec/GENESISBENCH_SIGNED_SUBMISSION_v0.1.schema.json",
    "genesisbench-registry-policy-schema": "docs/spec/GENESISBENCH_REGISTRY_POLICY_v0.1.schema.json",
    "genesisbench-registry-result-schema": "docs/spec/GENESISBENCH_REGISTRY_RESULT_v0.1.schema.json",
    "genesisbench-registry-event-schema": "docs/spec/GENESISBENCH_REGISTRY_EVENT_v0.1.schema.json",
    "genesisbench-registry-checkpoint-schema": "docs/spec/GENESISBENCH_REGISTRY_CHECKPOINT_v0.1.schema.json",
    "genesisbench-leaderboard-schema": "docs/spec/GENESISBENCH_LEADERBOARD_v0.1.schema.json",
...
COMPONENT_SELECTIONS = {
    "benchmark": {
        ...
        "includePrefixes": [
            ...
            "benchmarks/genesisbench/v0.1/construct-validity/",
        ],
