...
TOP_KEYS = {
    ...
    "scoringPolicy", "contaminationPolicy", "eligibilityPolicy",
...
ELIGIBILITY_POLICY = {
    ...
    "cohortKeys": [
        "attempt-policy", "contamination-label", "context-mode",
        "protocol-identity", "task-visibility", "tool-mode",
    ],
