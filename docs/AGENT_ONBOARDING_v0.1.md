...
9. `docs/spec/CLI_TOOLING_BUNDLE_v0.1.md`
10. `docs/spec/GCPM_BUNDLE_v0.1.md`
11. `docs/spec/HOST_RUNTIME_BUNDLE_v0.1.md`
12. `docs/spec/TESTING_BUNDLE_v0.1.md`
13. `docs/spec/AGENT_AUTHORING_BUNDLE_v0.1.md`
14. `docs/spec/WRITE_GENESISCODE_SKILL_PACK_v0.1.md`
15. `docs/spec/WRITE_GENESISCODE_SKILL_DISTRIBUTION_v1.md`
16. `ROADMAP.md` for strategic work or `upgrade_plan.md` for active P0/P1 defects
