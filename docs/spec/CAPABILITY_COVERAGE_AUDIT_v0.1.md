...
|---|---|---|---:|---:|---:|---|
| `browser/audio` | `planned` | `P0.4` | 2 | 2 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `browser/input` | `planned` | `P0.4` | 1 | 1 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `browser/storage` | `planned` | `P0.4` | 3 | 3 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `browser/window` | `planned` | `P0.4` | 3 | 3 | 0 | scripts/check_upgrade_plan_health.sh<br>scripts/check_webxr_browser_conformance_lane.sh |
...
| `core/sync` | `planned` | `P0.2` | 2 | 2 | 0 | scripts/check_gcpm_operation_contract_pack.sh<br>scripts/check_upgrade_plan_health.sh |
...
| `gfx/input` | `planned` | `P0.4` | 2 | 2 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `gfx/time` | `planned` | `P0.4` | 1 | 1 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `gfx/window` | `planned` | `P0.4` | 5 | 5 | 0 | scripts/check_gfx_runtime_profile.sh<br>scripts/check_upgrade_plan_health.sh |
| `gfx/xr` | `planned` | `P0.4` | 15 | 15 | 0 | scripts/check_gpu_xr_productization_kits.sh<br>scripts/check_webxr_browser_conformance_lane.sh |
| `gpu/compute` | `planned` | `P0.3` | 13 | 13 | 0 | scripts/check_agent_reference_workflows.sh<br>scripts/check_gpu_compute_runtime_profile.sh |
