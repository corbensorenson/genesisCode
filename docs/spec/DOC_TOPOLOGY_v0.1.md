...
- Agent profile lifecycle: `scripts/update_gc_agent_profile.sh` explicitly resolves source identities; `scripts/check_gc_agent_profile.sh` executes parser, evaluator, package, and resource cases and rejects unsupported-surface drift
