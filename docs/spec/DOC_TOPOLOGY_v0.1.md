...
- Normative source/CoreForm form authority: `docs/spec/NORMATIVE_FORM_MATRIX_v0.1.md` with content-addressed matrix `docs/spec/NORMATIVE_FORM_MATRIX_v0.1.json` and closed schema `docs/spec/NORMATIVE_FORM_MATRIX_v0.1.schema.json`
