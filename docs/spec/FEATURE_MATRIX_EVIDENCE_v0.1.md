...
| Deterministic concurrency/task runtime with replay semantics | `docs/spec/CLI.md`<br>`docs/spec/SEALS_DISPATCH_REPLAY.md`<br>`docs/spec/DETERMINISM.md`<br>`docs/spec/CONCURRENCY_v0.1.md` | `scripts/check_upgrade_plan_health.sh`<br>`scripts/check_no_user_panics.sh`<br>`scripts/check_task_concurrency_stress.sh` |
| WASM runtime + WASI CLI surfaces | `docs/spec/CLI.md` | `scripts/check_upgrade_plan_health.sh` |
| Schema-stable machine JSON contracts for CLI/tooling | `docs/spec/CLI.md`<br>`docs/spec/CLI_JSON_SCHEMAS_v0.1.md` | `scripts/check_upgrade_plan_health.sh`<br>`scripts/check_cli_diagnostics_contract.sh` |
