...
- `--selfhost-only`: enforce strict selfhost frontend mode.
  ...
  - Current routed set:
    - native: `fmt`, `eval`, `explain`, `debug/*`, `run`, `replay`, `optimize`, `typecheck`, `test`, `apply-patch`, `semantic-edit`, `pack`, `verify`, `selfhost-artifact`, `selfhost-dashboard`, `cli-schema`, `agent-index`, `agent-plan`, `keygen`, `sign`, `transparency-verify`, `store/*`, `refs/*`, `commit/*`, `pkg/*` (alias: `gcpm/*`), `policy/*`, `sync/*`, `gc/*`, `vcs/*`.
