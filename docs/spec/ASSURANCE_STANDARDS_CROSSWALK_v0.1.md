...
| RTCA DO-178C | DAL A | `do178c-dal-a` | `DO178C-A-INDEPENDENCE` | partial | `docs/spec/ASSURANCE_ARTIFACTS_v0.1.md`, `policies/assurance/profile_packs.toml` |
...
| RTCA DO-178C | DAL B | `do178c-dal-b` | `DO178C-B-INDEPENDENCE` | partial | `docs/spec/ASSURANCE_ARTIFACTS_v0.1.md` |
...
| NASA NPR 7150.2 | Class A | `nasa-class-a` | `NASA-A-IVV-INDEPENDENCE` | partial | `docs/spec/ASSURANCE_ARTIFACTS_v0.1.md` |
...
| NASA NPR 7150.2 | Class B | `nasa-class-b` | `NASA-B-INDEPENDENCE` | partial | `docs/spec/ASSURANCE_ARTIFACTS_v0.1.md` |
...
| --- | --- | --- | --- | --- |
| `DO178C-A-ORG-INDEPENDENCE-PROGRAM` | RTCA DO-178C DAL A | open | program-governance | `upgrade_plan.md#P2.1` |
| `DO178C-B-AUTHORITY-SIGNOFF` | RTCA DO-178C DAL B | open | program-governance | `upgrade_plan.md#P2.1` |
| `NASA-A-IVV-GOVERNANCE` | NASA NPR 7150.2 Class A | open | program-governance | `upgrade_plan.md#P2.1` |
| `NASA-B-IVV-ORG-SCOPE` | NASA NPR 7150.2 Class B | open | program-governance | `upgrade_plan.md#P2.1` |
| `IEC62304-C-QMS-INTEGRATION` | IEC 62304 Class C | open | program-governance | `upgrade_plan.md#P2.1` |
