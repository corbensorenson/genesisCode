...
- [x] **R1.2.c Add repair hints with guardrails.** Hints may propose syntax/contract/capability changes but never silently broaden policy or suppress an obligation. Capability broadening is a separately reviewable policy diff. done 2026-07-11; evidence: `scripts/check_cli_diagnostics_contract.sh`; input: `guarded-repair-hints-bundle-sha256:7535f10dc9a09adaf29a10347099d16766ed4bfd101dd05a7f21dbb53e97b00d`
